...
<head>
    ...
    <link id="pagestyle" href="{{ url('public') }}/css/app.css?v=1092" rel="stylesheet"/>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
                ...
                <div class=" text-center">
                    ...
                    <div class=" ">
                        <div class="avatar rounded-circle avatar-xl position-relative ">
                            ...
                            @else
                                <img src="{{ url('public') }}/uploads/{{$student->photo}}" class="w-100 border-radius-lg shadow-sm">
                            @endif
            ...
            <li class="nav-item mt-4">
                <a class="nav-link @if(($selected_navigation ?? '') === 'dashboard') active @endif" href="{{ url('student/dashboard')}}">
            ...
            <li class="nav-item ">
                <a class="nav-link @if(($selected_navigation ?? '') === 'student-course') active @endif " href="{{ url('student/my-courses')}}">
            ...
            <li class="nav-item ">
                <a class="nav-link @if(($selected_navigation ?? '') === 'recipes') active @endif " href="{{ url('student/ebooks')}}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book-open"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>
                    <span class="nav-link-text  ms-3">{{__('Recipes')}}</span>
                </a>
            </li>
            <li class="nav-item ">
                <a class="nav-link @if(($selected_navigation ?? '') === 'assignments') active @endif " href="{{ url('student/assignments')}}">
            ...
            <li class="nav-item">
                <a class="nav-link @if(($selected_navigation ?? '') === 'student-certificates') active @endif"
                   href="{{ url('student/my-certificates') }}">
            ...
            <li class="nav-item">
                <a class="nav-link @if(($selected_navigation ?? '') === 'points') active @endif"
                   href="{{ url('student/points') }}">

                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-circle"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                    <span class="nav-link-text  ms-3">{{__('Points')}}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link @if(($selected_navigation ?? '') === 'pts') active @endif"
                   href="{{ url('student/pts') }}">

                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-circle"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                    <span class="nav-link-text  ms-3">{{__('PTS')}}</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link @if(($selected_navigation ?? '') === 'my-profile') active @endif " href="{{ url('student/profile') }}">
            ...
            <li class="nav-item mb-4">
                <a class="nav-link " href="{{ url('student-logout') }}">
...
<!--   Core JS Files   -->
<script src="{{ url('public') }}/js/app.js?v=100"></script>
<script src="{{ url('public') }}/lib/tinymce/tinymce.min.js?v=59"></script>
<script>
    (function(){
        "use strict";
