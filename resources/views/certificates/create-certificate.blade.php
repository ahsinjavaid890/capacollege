    ...
    <div class="row">
        <div class="col-md-12 mb-5">
            <form action="{{ url('save-certificate-template')}}" method="post" enctype="multipart/form-data">
                <input type="hidden"  name="type" value="coursecertificate">
                @if ($errors->any())
                ...
                <div class="card ">
                 ...
                 <h5 class="card-title">{{__('Create Course Certificate Template')}}</h5>
                   </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3 ">
                            ...
                            <select required class="form-select form-select-solid fw-bolder" id="contact"
