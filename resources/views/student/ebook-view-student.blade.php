...
@section('content')
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('save-ebook-purchased')}}" method="post">
                        @if ($errors->any())
                                ...
                                <td>
                                    ...
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            @if(!empty($courses[$course_purchase->product_id]->image))
                                                @if(isset($courses[$course_purchase->product_id]))
                                                    <img src="{{ url('public') }}/uploads/{{$courses[$course_purchase->product_id]->image}}"
                                        ...
                                        <div class="d-flex flex-column justify-content-center ms-3">
                                            <a href="{{ url('view-product')}}?id={{$courses[$course_purchase->product_id]->id}}" class="text-dark font-weight-normal"> <h6 class=" mb-0 ">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-lg-start px-2 py-3"
                                                aria-labelledby="dropdownMarketingCard">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item border-radius-md"
                                                           href="{{ url('view-product')}}?id={{$courses[$course_purchase->product_id]->id}}">{{__('See Details')}}</a>
                                                    </li>
                                                ...
                                                <li>
                                                    <a class="dropdown-item border-radius-md text-danger"
                                                       href="{{ url('delete/ebook-purchase')}}/{{$course_purchase->id}}">{{__('Delete')}}
                                                    </a>
                                                </li>
                                            </ul>
